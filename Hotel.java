...
public class Hotel extends JFrame implements ActionListener
{
	...
	super("Software for Hotel Management System");
		...
		ImageIcon ic = new ImageIcon("images (9).jpg");
		...
		l53=new JLabel("HARD ROCK");
		l54=new JLabel(" ");
		l55=new JLabel("Welcome");
		l57=new JLabel(" ");
		l58=new JLabel("Customer Details");
		l59=new JLabel(" ");
		l60=new JLabel("Booking Details");
		l61=new JLabel(" ");
		...
		ImageIcon ic1 = new ImageIcon("images (2).jpg");
  		JLabel image1=new JLabel(ic1,JLabel.CENTER);
		...
		t8.setEnabled(false);
		t9.setEnabled(false);
		//addCustomer(image,0,0,1024,768);
		...
		addCustomer(image1,0,0,1024,768);
		//Initialising Registration Form

		ImageIcon ic2 = new ImageIcon("images (3).jpg");
  		JLabel image2=new JLabel(ic2,JLabel.CENTER);
  		image2.setBounds(0,0,1024,768); 
  		
		l18=new JLabel("UserName");
		l19=new JLabel("Password");
		l20=new JLabel("conform Password");
		l18.setFont(mfnt1);
		l19.setFont(mfnt1);
		l20.setFont(mfnt1);
		...
		addBooking(image2,0,0,1024,768);
		...
		ImageIcon ic3 = new ImageIcon("photo.jpg.jpeg");
  		JLabel image3=new JLabel(ic3,JLabel.CENTER);
  		image3.setBounds(0,0,1024,768); 
		...
		addBill(image3,0,0,1024,768);

		//Initialising Main Form Objects

		ImageIcon ic4 = new ImageIcon("images (7).jpg");
  		JLabel image4=new JLabel(ic4,JLabel.CENTER);
		...
		addMain(image4,0,0,1024,768);

		//Initialising Thanks Form Objects

		l46=new JLabel("Thanks for using this software.");
		l47=new JLabel("This software is developed by 'KARAN THOPATE'  ");
		l46.setFont(mfnt);
		l47.setFont(mfnt);
		...
		ImageIcon ic5 = new ImageIcon("images (8).jpg");
  		JLabel image5=new JLabel(ic3,JLabel.CENTER);
		...
		addMenu(image5,0,0,1024,768);

		//Initialising Enquiry Form Objects
		
		ImageIcon ic6 = new ImageIcon("photo.jpg.jpeg");
  		JLabel image6=new JLabel(ic6,JLabel.CENTER);
		...
		addEnquiry(image6,0,0,1024,768);
		 ...
		 try
			{
				...
				con=DriverManager.getConnection("jdbc:postgresql://localhost/test","postgres","postgres");

			}
		catch(Exception e)
			{
				t1.setText("Error in Connection --> "+e);
			}
	}
...
public void actionPerformed(ActionEvent ee)
	{
		...
		if(ee.getSource()==b1)
		{
			...
			{
				JOptionPane.showMessageDialog(t1,"Illegal User Name or Password");
				t2.setText("");
			}
		}
		if(ee.getSource()==b2)
		...
		if(ee.getSource()==b4)
			...
			try
			{
				...
				ps.setString(13,t10.getText()==10);
								
				ps.setString(14,t11.getText());
				ps.setString(15,(String)cb1.getSelectedItem());
				int i;
				i=ps.executeUpdate();
				JOptionPane.showMessageDialog(t3,"Customer details successfully added");
				t4.setText("");
				t5.setText("");
				r1.setSelected(true);
			...
			{
				JOptionPane.showMessageDialog(t3,"Error in adding Customer details"+e);
			}
			}
		...
		if(ee.getSource()==b6)
		{
			try
			{
				...
				{
					JOptionPane.showMessageDialog(t12,"Please retype your UserName And Password correctly");
				}
			}
			catch(Exception e)
				{
					JOptionPane.showMessageDialog(t12,"Error in  making new account");
				}
		}
		if(ee.getSource()==b7)
			{
		...
		if(ee.getSource()==b8)
		{
			try
			{
				ps=con.prepareStatement("Insert into Booking1 values (?,?,?,?,?,?)");
				...
				i=ps.executeUpdate();
				JOptionPane.showMessageDialog(t15,"Booking successfully added");
				t16.setText("");
				t17.setText("");
				t20.setText("");
				t21.setText("");
			...
			{
				JOptionPane.showMessageDialog(t15,"Error in Booking"+e);
			}
		}
		if(ee.getSource()==b9)
			{
		...
		if(ee.getSource()==b12)
			{
				...
				{
					JOptionPane.showMessageDialog(t17,"Sorry !! No Rooms are Available");
				}
				cl.show(p,"Rooms");
			}
		if(ee.getSource()==b13)
			...
			ps.setInt(4,Integer.parseInt(t27.getText()));
				...
				int i;
				i=ps.executeUpdate();
				JOptionPane.showMessageDialog(t24,"Billing successfully done");
			...
			{
				JOptionPane.showMessageDialog(t24,"Error in Billing");
				t25.setText("");
				t26.setText("");
				t27.setText("");
				t28.setText("");
		...
		if(ee.getSource()==b15)
			...
			try
			{
				ps=con.prepareStatement("Select max(ccode) from Customer");
				rs=ps.executeQuery();
				rs.next();
				str=rs.getString(1);
				...
				{
					JOptionPane.showMessageDialog(t3,"Error in Code generation"+e3);
				}
				cl.show(p,"Customer");
			}
		if(ee.getSource()==b16)
		{
			...
			try
			{
				ps=con.prepareStatement("Select max(BNo) from Booking");
				rs=ps.executeQuery();
				rs.next();
				str=rs.getString(1);
				num=Integer.parseInt(str.substring(1));
			...
			{
				JOptionPane.showMessageDialog(t15,"Error in Code generation"+e3);
			}
			cl.show(p,"Booking");
			t17.setText("");
		}
		if(ee.getSource()==b17)
			...
			try
			{
				ps=con.prepareStatement("Select max(BillNo) from Billing");
				rs=ps.executeQuery();
				rs.next();
				str=rs.getString(1);
			...
			{
				JOptionPane.showMessageDialog(t24,"Error in Code generation"+e3);
			}
			cl.show(p,"Bill");
			}
		if(ee.getSource()==b18)
		...
		if(ee.getSource()==b26)
			{
				try
				{
					...
					t40.setEnabled(true);
					JOptionPane.showMessageDialog(t40,"Details added successfully");
					t41.setText("0");
					t42.setText("0");
					t43.setText("0");
					t44.setText("0");
				...
				{
					t40.setEnabled(true);
					JOptionPane.showMessageDialog(t40,"Error in adding details");
					t41.setText("0");
					t42.setText("0");
					t43.setText("0");
					t44.setText("0");
		...
		if(ee.getSource()==b30)
			...
			String rr="";
				...
				{
					JOptionPane.showMessageDialog(t51,"Error in finding record " + rr);
				}
			}
		if(ee.getSource()==r1)
			{
...
public void focusGained(FocusEvent e)
		...
		public void focusLost(FocusEvent e)
		{
			...
			{
				JOptionPane.showMessageDialog(t13,"Invalid Customer  No. ! Try Again");
				t20.setText("");
				ta4.setText("");
			...
			try
			{
				ps=con.prepareStatement("Select * from Booking1 where BNo=?");
				ps.setString(1,t25.getText());
				rs=ps.executeQuery();
				rs.next();
				t38.setText(rs.getString(3));
				t39.setText(rs.getString(4));
				ps=con.prepareStatement("Select ddate from billing");
				rs=ps.executeQuery();
				rs.next();
				t26.setText(rs.getString(1));
				//ps=con.prepareStatement("Select bdays=?,trr=? from billing");
			...
			{
				JOptionPane.showMessageDialog(t25,"Invalid Booking  No. ! Try Again " + ex.getMessage());
			}
			}
			if(e.getSource()==t33)
			{
			...
			if(e.getSource()==t50)
			{
				...
				{
					JOptionPane.showMessageDialog(t50,"Sorry !! No such record Available");
				}
